...
repos_list = [
    "Shisir1/QR-Code-Generator", "Shisir1/Spring-Boot-User-Management",
    "Shisir1/Spring-Boot-REST-Employee-Mgmt", "Shisir1/airbnb-clone-1",
    "Shisir1/Trello-Clone-React-TypeScript", "Shisir1/moneyManagerJS",
    "Shisir1/Quote-Generator", "Shisir1/Drone-Shopping-App",
    "Shisir1/NBA_Wins"
]
